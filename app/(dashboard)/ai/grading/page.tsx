    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card className="border-l-4 border-l-slate-900 shadow-sm">
          <CardHeader className="pb-2">
            <CardDescription className="text-xs font-semibold   text-slate-500">Total Batches Audited</CardDescription>
            <CardTitle className="text-2xl font-semibold text-slate-900">{processedData.totalProcessed.toLocaleString()}</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-xs font-semibold text-slate-500 ">National Quality Pipeline</p>
          </CardContent>
        </Card>

        <Card className="border-l-4 border-l-emerald-500 shadow-sm">
          <CardHeader className="pb-2">
            <CardDescription className="text-xs font-semibold   text-slate-500">Average AI Accuracy</CardDescription>
            <CardTitle className="text-2xl font-semibold text-slate-900">{processedData.avgAccuracy}%</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-l-4 border-l-blue-500 shadow-sm">
          <CardHeader className="pb-2">
            <CardDescription className="text-xs font-semibold   text-slate-500">Processing Speed</CardDescription>
            <CardTitle className="text-2xl font-semibold text-slate-900">2.4 <span className="text-sm font-bold text-slate-400">MIN</span></CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-xs font-semibold text-blue-600 ">18x Faster than Manual</p>
          </CardContent>
        </Card>

        <Card className="border-l-4 border-l-slate-900 shadow-sm">
          <CardHeader className="pb-2">
            <CardDescription className="text-xs font-semibold   text-slate-500">Premium Yield (A)</CardDescription>
            <CardTitle className="text-2xl font-semibold text-slate-900">{processedData.gradeAPercent}%</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <Card className="border-2 shadow-sm overflow-hidden">
        <CardHeader className="border-b bg-slate-50/50">
          <CardTitle className="text-sm font-semibold   text-slate-900">Recent Automated Grading Batches</CardTitle>
        </CardHeader>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-100/50 border-b">
                  <th className="p-4 text-xs font-semibold  text-slate-500">Batch Info</th>
                  <th className="p-4 text-xs font-semibold  text-slate-500">Location</th>
                  <th className="p-4 text-xs font-semibold  text-slate-500 text-center">Total Unit</th>
                  <th className="p-4 text-xs font-semibold  text-slate-500 text-center text-emerald-600">Grade A</th>
                  <th className="p-4 text-xs font-semibold  text-slate-500 text-center text-amber-600">Grade B</th>
                  <th className="p-4 text-xs font-semibold  text-slate-500 text-center text-rose-600">Grade C</th>
                  <th className="p-4 text-xs font-semibold  text-slate-500 text-right">Confidence</th>
                </tr>
              </thead>
              <tbody className="divide-y">
                {processedData.results.map((item, idx) => (
                  <tr key={idx} className="hover:bg-slate-50 transition-colors">
                    <td className="p-4">
                      <p className="text-xs font-semibold text-slate-900 ">{item.batch}</p>
                    ...
                    <td className="p-4 text-center text-xs font-semibold text-slate-900">{item.jumlah}</td>
                    <td className="p-4 text-center text-xs font-semibold text-emerald-600">{item.gradingA}</td>
                    <td className="p-4 text-center text-xs font-semibold text-amber-600">{item.gradingB}</td>
                    <td className="p-4 text-center text-xs font-semibold text-rose-600">{item.gradingC}</td>
                    <td className="p-4 text-right">
                      <div className="flex flex-col items-end gap-1">
                        <span className="text-xs font-semibold text-slate-900">{item.accuracy}%</span>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card className="border-2 shadow-sm">
          <CardHeader className="border-b bg-slate-50/50">
            <CardTitle className="text-sm font-semibold   text-slate-900">AI Computer Vision Quality Metrics</CardTitle>
            <CardDescription className="text-xs font-bold  text-slate-500">Model accuracy per assessment parameter</CardDescription>
          </CardHeader>
          <CardContent className="p-6 space-y-5">
            {qualityMetrics.map((metric) => (
              <div key={metric.metrik} className="space-y-1.5">
                <div className="flex justify-between items-center">
                  <span className="text-xs font-semibold  text-slate-600">{metric.metrik}</span>
                  <span className="text-xs font-semibold text-slate-900">{metric.nilai}%</span>
                </div>
            ...
            <div className="pt-4 border-t mt-4 flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-semibold  text-slate-500 ">Model Compliance: ISO 9001-AI</span>
              </div>
              <Button variant="ghost" className="h-6 text-xs font-semibold  text-slate-400">RECALIBRATE</Button>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-2 shadow-sm">
          <CardHeader className="border-b bg-slate-50/50">
            <CardTitle className="text-sm font-semibold   text-slate-900">National Grade Distribution</CardTitle>
            <CardDescription className="text-xs font-bold  text-slate-500">Aggregate quality breakdown across active regions</CardDescription>
          </CardHeader>
      ...
      <Card className="border-2 shadow-sm">
        <CardHeader className="border-b bg-slate-50/50">
          <CardTitle className="text-sm font-semibold   text-slate-900">Processing Efficiency Analysis</CardTitle>
          <CardDescription className="text-xs font-bold  text-slate-500">Audit of time-cost savings through AI integration</CardDescription>
        </CardHeader>
        <CardContent className="pt-6">
        ...
        <div className="flex">
          ...
          <div className="p-6 flex-1 space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-semibold  ">AI Quality Audit Summary</h3>
              <Badge className="bg-emerald-500 text-slate-900 font-semibold ">Standard Compliant</Badge>
            </div>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-3 bg-slate-800 rounded border border-slate-700">
                <p className="text-xs font-semibold text-purple-400  mb-1">Consistency Audit</p>
              ...
              <div className="p-3 bg-slate-800 rounded border border-slate-700">
                <p className="text-xs font-semibold text-emerald-400  mb-1">Economic Impact</p>
                <p className="text-xs font-medium text-slate-300">
