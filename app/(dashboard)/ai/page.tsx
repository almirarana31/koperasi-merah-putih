      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex gap-2">
            <Button variant="outline" className="font-semibold border-2 text-xs  h-8  border-slate-200">
              <Activity className="mr-2 h-4 w-4" /> SYSTEM HEALTH
            </Button>
            <Button className="bg-slate-900 font-semibold text-xs  h-8 ">
          ...
          <Link href={model.href} key={model.id} className="group">
            <Card className="border-none group-hover:bg-slate-50 transition-all h-full shadow-sm overflow-hidden">
              ...
              <CardContent className="p-4 pt-0 space-y-3">
                <p className="text-xs font-bold text-slate-400  leading-tight">{model.description}</p>
                <div className="flex items-center justify-between pt-2 border-t border-dashed border-slate-200">
                  <Badge variant="outline" className="text-xs font-semibold  border-slate-900 px-1.5 h-4">ACC: {model.accuracy}</Badge>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2 border-none shadow-sm">
          <CardHeader className="border-b border-slate-100 bg-slate-50/50">
            <CardTitle className="text-xs font-semibold   text-slate-900">Model Performance Matrix</CardTitle>
            <CardDescription className="text-xs font-bold  text-slate-500 ">CROSS-FUNCTIONAL ACCURACY & IMPACT AUDIT</CardDescription>
          </CardHeader>
        ...
        <Card className="border-none shadow-sm">
          <CardHeader className="border-b border-slate-100 bg-slate-50/50">
            <CardTitle className="text-xs font-semibold   text-slate-900">Precision Distribution</CardTitle>
            <CardDescription className="text-xs font-bold  text-slate-500 ">AGGREGATE MODEL RELIABILITY AUDIT</CardDescription>
          </CardHeader>
          <CardContent className="pt-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="border-none shadow-sm overflow-hidden">
            ...
            {aiAnalyses.slice(0, 4).map((analysis) => (
              <div key={analysis.id} className="p-4 hover:bg-slate-50 transition-colors">
                <div className="flex justify-between items-start mb-1">
                  ...
                  <span className="text-xs font-bold text-slate-400  ">{analysis.createdAt}</span>
                </div>
                <p className="text-xs font-bold text-slate-500 leading-tight mb-2 ">{analysis.description}</p>
                <Badge className="bg-emerald-50 text-emerald-700 font-semibold text-xs  border-emerald-100 px-1.5 h-4">
          ...
          <div className="p-3 bg-slate-50 border-t border-slate-100">
            <Button variant="ghost" className="w-full h-6 text-xs font-semibold text-slate-600 hover:text-slate-900  ">
        ...
        <Card className="border-none shadow-sm bg-slate-900 text-white flex flex-col justify-between">
          ...
          <CardContent className="p-6 space-y-4 flex-1">
            <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-xl relative group overflow-hidden">
              ...
              <p className="text-xs font-semibold text-emerald-400  mb-2 ">REVENUE MAXIMIZATION</p>
              <p className="text-xs font-bold text-slate-200  leading-relaxed ">
                Recommend shifting <span className="text-white font-semibold">Grade A Padi</span> pricing by +8.2% across West Java nodes to capture high seasonal inelasticity.
              </p>
            </div>
            <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-xl relative group overflow-hidden">
              ...
              <p className="text-xs font-semibold text-blue-400  mb-2 ">LOGISTICS EFFICIENCY</p>
              <p className="text-xs font-bold text-slate-200  leading-relaxed ">
                Freight consolidation in <span className="text-white font-semibold">East Java Hub</span> can reduce deadhead mileage by 22% this week. Initiate route batching.
              </p>
            </div>
            <div className="p-4 bg-rose-500/10 border border-rose-500/20 rounded-xl relative group overflow-hidden">
              ...
              <p className="text-xs font-semibold text-rose-400  mb-2 ">RISK MITIGATION</p>
              <p className="text-xs font-bold text-slate-200  leading-relaxed ">
                Predicted shortage of <span className="text-white font-semibold">Chili</span> in Central Java. Triggering strategic reserve movement from surplus nodes.
              </p>
            </div>
          </CardContent>
          <div className="p-4 border-t border-slate-800 bg-slate-900/50">
            <Button className="w-full bg-white text-slate-900 font-semibold text-xs  h-10 hover:bg-slate-100  transition-all">
