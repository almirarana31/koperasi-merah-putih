        ...
        <Card className="border-slate-200 bg-white shadow-sm overflow-hidden">
          <CardContent className="p-6">
            ...
            <div className="mt-6 flex gap-2">
              <Button size="sm" className="flex-1 rounded-xl font-black text-[10px] uppercase tracking-widest bg-slate-900 hover:bg-slate-800 shadow-md shadow-slate-200">Input Transaksi</Button>
            ...
            <div className="h-[280px] w-full mt-4">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={transactionData}>
                  ...
                  <XAxis dataKey="time" fontSize={10} fontWeights="900" axisLine={false} tickLine={false} tick={{ fontSize: 10 }} />
